...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Christopher J.}{Miller}
\address{3527 SW 20th Ave, Apt. 718, Gainesville, FL 32607}
\mobile{(941) 374-1788} 
%%% Social
\email{cmiller548@gmail.com}
\homepage{chrismiller.xyz}
\github{ChristopherJMiller}
\linkedin{ChristopherJMill}
%%% Optionals
\position{Computer Engineering Student{\enskip\cdotp\enskip}Software Developer}
